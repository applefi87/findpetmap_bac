...
import { createArticle, updateArticle, deleteArticle, getArticleDetail, searchArticleList, searchMyArticle } from '../controllers/articleController.js';
...
router.post('/my', content('application/json'), auth.jwt("_id"), searchMyArticle);
